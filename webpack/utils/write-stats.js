...
const filepath = path.resolve(__dirname, '../../app/webpack-stats.json');
...
export default function (stats) {
    ...
    const script = getChunks('vendors', /js/).concat(getChunks('app', /js/));
    const style = getChunks('vendors', /css/).concat(getChunks('app', /css/));
